...
namespace ConversaStudio.PostgresMigrations
{
    ...
    [Migration("20260402100044_AddTemplateDefinitions")]
    partial class AddTemplateDefinitions
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ConversaStudio.Domains.Bots.BotDefinition", b =>
                {
                    ...
                    b.Property<string>("AiEmbeddingModel")
                        .HasMaxLength(64)
                        .HasColumnType("character varying(64)");

                    b.Property<string>("AiGenerationModel")
                        .HasMaxLength(64)
                        .HasColumnType("character varying(64)");

                    b.Property<string>("AiKnowledgeJson")
                        .IsRequired()
                        .HasColumnType("text");
                    ...
                    b.ToTable("AppBotDefinitions", (string)null);
                });

            modelBuilder.Entity("ConversaStudio.Domains.Deployments.BotDeployment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<Guid>("BotDefinitionId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("DeploymentKey")
                        .IsUnique();

                    b.HasIndex("TenantId", "BotDefinitionId", "CreationTime");

                    b.ToTable("AppBotDeployments", (string)null);
                });

            modelBuilder.Entity("ConversaStudio.Domains.Runtime.RuntimeSession", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");

                    b.Property<bool>("AwaitingInput")
                        .HasColumnType("boolean");

                    b.Property<Guid>("BotDefinitionId")
                        .HasColumnType("uuid");

                    b.Property<Guid>("BotDeploymentId")
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("PendingQuestionVariable")
                        .HasMaxLength(128)
                        .HasColumnType("character varying(128)");
                    ...
                    b.HasIndex("TenantId", "BotDeploymentId", "CreationTime");

                    b.ToTable("AppRuntimeSessions", (string)null);
                });

            modelBuilder.Entity("ConversaStudio.Domains.Templates.TemplateDefinition", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("TenantId", "Status", "LastModificationTime");

                    b.ToTable("AppTemplateDefinitions", (string)null);
                });

            modelBuilder.Entity("ConversaStudio.Domains.Transcripts.TranscriptMessage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("TenantId", "RuntimeSessionId", "CreationTime");

                    b.ToTable("AppTranscriptMessages", (string)null);
                });
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("ConversaStudio.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("ConversaStudio.Authorization.Users.User", null)
                        .WithMany("Claims")
